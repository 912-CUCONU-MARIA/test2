 ...
 * 3. when a connection handler child finishes its job successfully.
 * 4. When client closes connection abruptly, so connection handler child had to exit.
 *
*/
