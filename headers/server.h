...
#ifndef FTP_PROJECT_SERVER_H
#define FTP_PROJECT_SERVER_H
...
private:
    ...
    // When accept() call is blocking, how many potential connections are
    // allowed to queue up
...
public:
    ...
    Server()
            : controlConnectionIP{ "" },
              ...
              dataConnectionPortNumber{ controlConnectionPortNumber +
                                        FTP::OFFSET_dataConnectionToClient },
              backlogsPermitted{ 10 } {}

    // Paramterized constructor
    Server(const int _controlConnectionPortNumber, int _backlogsPermitted = 10)
            : controlConnectionIP{ "" },
    ...
    int RecvWithTimeout(int controlConnectionfd,
